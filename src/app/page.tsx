...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'en_US',
    images: [{ url: '/brand/eyeq-logo-original.png', width: 1024, height: 1024, alt: 'EyeQ' }],
  },
  twitter: {
    card: 'summary',
    title: 'EyeQ AI | A Home for Connected Eye Care',
    ...
    images: ['/brand/eyeq-logo-original.png'],
  },
  icons: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: 'EyeQ AI',
            url: publicEnv.appUrl,
            logo: `${publicEnv.appUrl}/brand/eyeq-logo-original.png`,
            description:
