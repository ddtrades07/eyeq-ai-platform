...
export const DEMO_ROLE_ACCOUNTS: DemoRoleAccount[] = [
  {
    ...
    description: 'Business, readiness, staff, support, and launch controls.',
    workflows: [
      'Review practice performance',
      'Check PHI and vendor readiness',
      'Approve Google review drafts',
      'Open support and audit logs',
    ],
    redirect: '/provider/demo-walkthrough',
  },
  {
    key: 'optometrist',
    ...
    lastName: 'Shah',
    title: 'Optometrist',
    description: 'Charting, imaging, AI drafts, prescriptions, and messages.',
    workflows: [
  ...
  },
  {
    ...
    workflows: [
      ...
      'Move patients through the visit board',
  ...
  },
  {
    ...
    lastName: 'Thompson',
    title: 'Patient',
    description: 'Portal, visits, prescriptions, messages, and forms.',
    workflows: [
