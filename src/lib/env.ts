...
export const serverEnv = {
  ...
  stripePricePilot: optional('STRIPE_PRICE_PILOT'),
  stripePricePractice: optional('STRIPE_PRICE_PRACTICE'),
  stripePriceGrowth: optional('STRIPE_PRICE_GROWTH'),
  stripePriceEnterprise: optional('STRIPE_PRICE_ENTERPRISE'),
  billingGracePeriodDays: Number(optional('BILLING_GRACE_PERIOD_DAYS', '7')) || 7,
